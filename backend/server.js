...
// const dbRoute = "mongodb://merntest:merntest123@ds211275.mlab.com:11275/merntest";
...
router.post('/saveData', function(req, res, next){
    ...
    let data = new Data();
    data.fielddata = req.body.fielddata;         
    data.save(function (err) {
        if (err) {
            res.json({ 'success': false, 'message': 'Error in Saving Data', errors: err });
        } else {
